...
#poly
svm_model = SVC(random_state=42,C=120,gamma=2.4,kernel="poly",probability=True)
...
#poly12
svm_model4 = SVC(random_state=42,C=120,degree=12,gamma=2.4,kernel="poly",probability=True)
...
plt.subplot(2,3,5)
plt.title("SVM Confusion Matrix polynomial(deg=12)")
sns.heatmap(cm_svm4,cbar=False,annot=True,cmap="CMRmap_r",fmt="d")
#poly13
svm_model5 = SVC(random_state=42,C=120,degree=13,gamma=2.4,kernel="poly",probability=True)
...
plt.subplot(2,3,4)
plt.title("SVM Confusion Matrix polynomial(deg=13)")
sns.heatmap(cm_svm5,cbar=False,annot=True,cmap="CMRmap_r",fmt="d")
#rbf
svm_model1 = SVC(random_state=42,C=120,gamma=2.4,kernel="rbf",probability=True)
...
#sigmoid
svm_model2 = SVC(random_state=42,C=120,gamma=2.4,kernel="sigmoid",probability=True)
